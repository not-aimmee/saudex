...
// @ts-ignore - optional external runtime dependency
...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  useEffect(() => {
    if (typeof document !== 'undefined' && (document as any).fonts?.status === 'loaded') {
      setFontsLoaded(true);
    } else if (typeof document !== 'undefined' && (document as any).fonts?.ready) {
  ...
  useGSAP(
    () => {
      ...
      return () => {
        (ScrollTrigger as any).getAll().forEach((st: any) => {
